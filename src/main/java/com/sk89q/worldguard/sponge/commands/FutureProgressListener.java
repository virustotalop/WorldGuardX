...
public class FutureProgressListener implements Runnable {
    ...
    public FutureProgressListener(CommandSource sender, String message) {
        checkNotNull(sender);
        checkNotNull(message);

        task = new MessageTimerTask(sender, Texts.of(TextColors.GRAY, message));
    ...
    public static void addProgressListener(ListenableFuture<?> future, CommandSource sender, String message) {
