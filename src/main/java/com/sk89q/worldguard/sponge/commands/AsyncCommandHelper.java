...
public class AsyncCommandHelper {
    ...
    private AsyncCommandHelper(ListenableFuture<?> future, WorldGuardPlugin plugin, CommandSource sender) {
        checkNotNull(future);
        checkNotNull(plugin);
        checkNotNull(sender);
    ...
    public static AsyncCommandHelper wrap(ListenableFuture<?> future, WorldGuardPlugin plugin, CommandSource sender) {
