...
package com.sk89q.worldguard.sponge.commands.task;
...
public class RegionLister implements Callable<Integer> {
    ...
    public RegionLister(WorldGuardPlugin plugin, RegionManager manager, CommandSource sender) {
        checkNotNull(plugin);
    ...
    public Integer call() throws Exception {
        ...
        if (page < pages) {
            ...
            for (int i = page * pageSize; i < page * pageSize + pageSize; i++) {
                ...
                sender.sendMessage(Texts.of(TextColors.YELLOW, entries.get(i)));
            }
        }
