...
import com.sk89q.worldguard.sponge.commands.AsyncCommandHelper;
import com.sk89q.worldguard.sponge.commands.CommandUtils;
import com.sk89q.worldguard.sponge.commands.FutureProgressListener;
import com.sk89q.worldguard.sponge.commands.MessageFutureCallback.Builder;
import com.sk89q.worldguard.sponge.commands.task.RegionAdder;
import com.sk89q.worldguard.sponge.commands.task.RegionLister;
import com.sk89q.worldguard.sponge.commands.task.RegionManagerReloader;
import com.sk89q.worldguard.sponge.commands.task.RegionManagerSaver;
import com.sk89q.worldguard.sponge.commands.task.RegionRemover;
...
public final class RegionCommands extends RegionCommandsBase {
    ...
    @Command(aliases = {"define", "def", "d", "create"},
             ...
             min = 1)
    public void define(CommandContext args, CommandSource sender) throws CommandException {
    ...
    @Command(aliases = {"redefine", "update", "move"},
             ...
             flags = "g",
             min = 1, max = 1)
    public void redefine(CommandContext args, CommandSource sender) throws CommandException {
        warnAboutSaveFailures(sender);
    ...
    @Command(aliases = {"claim"},
             ...
             desc = "Claim a region",
             min = 1)
    public void claim(CommandContext args, CommandSource sender) throws CommandException {
        warnAboutSaveFailures(sender);
        ...
        if (!permModel.mayClaimRegionsUnbounded()) {
            ...
            if (region.volume() > wcfg.maxClaimVolume) {
                player.sendMessage(Texts.of(TextColors.RED,  "This region is too large to claim."));
                player.sendMessage(Texts.of(TextColors.RED,
    ...
    @Command(aliases = {"select", "sel", "s"},
             ...
             min = 0, max = 1)
    public void select(CommandContext args, CommandSource sender) throws CommandException {
        Player player = plugin.checkPlayer(sender);
        World world = player.getWorld();
        RegionManager manager = checkRegionManager(plugin, world);
    ...
    @Command(aliases = {"info", "i"},
             ...
             min = 0, max = 1)
    public void info(CommandContext args, CommandSource sender) throws CommandException {
        warnAboutSaveFailures(sender);
    ...
    @Command(aliases = {"flag", "f"},
             ...
             desc = "Set flags",
             min = 2)
    public void flag(CommandContext args, CommandSource sender) throws CommandException {
        warnAboutSaveFailures(sender);
        ...
        if (foundFlag == null) {
            ...
            sender.sendMessage(Texts.of(TextColors.RED, "Unknown flag specified: " + flagName));
            sender.sendMessage(Texts.of(TextColors.RED, "Available " + "flags: " + list));
        ...
        if (value != null) {
            ...
            sender.sendMessage(Texts.of(TextColors.RED,
        ...
        // No value? Clear the flag, if -g isn't specified
            ...
            sender.sendMessage(Texts.of(TextColors.YELLOW,
    ...
    @Command(aliases = {"setpriority", "priority", "pri"},
             ...
             min = 2, max = 2)
    public void setPriority(CommandContext args, CommandSource sender) throws CommandException {
        warnAboutSaveFailures(sender);
    ...
    @Command(aliases = {"setparent", "parent", "par"},
             ...
             min = 1, max = 2)
    public void setParent(CommandContext args, CommandSource sender) throws CommandException {
        warnAboutSaveFailures(sender);
        ...
        try {
            ...
            assert parent != null;
            printout.append(Texts.of(TextColors.RED, "Uh oh! Setting '" + parent.getId() + "' to be the parent " +
                    "of '" + child.getId() + "' would cause circular inheritance.\n"));
            printout.append(Texts.of(TextColors.GRAY, "(Current inheritance on '" + parent.getId() + "':\n"));
            printout.appendParentTree(true);
            printout.append(Texts.of(TextColors.GRAY, ")"));
            printout.send(sender);
            return;
        }
        ...
        printout.append(Texts.of(TextColors.YELLOW, "Inheritance set for region '" + child.getId() + "'.\n"));
        if (parent != null) {
            printout.append(Texts.of(TextColors.GRAY, "(Current inheritance:\n"));
            printout.appendParentTree(true);
            printout.append(Texts.of(TextColors.GRAY, ")"));
        }
        printout.send(sender);
    ...
    @Command(aliases = {"remove", "delete", "del", "rem"},
             ...
             min = 1, max = 1)
    public void remove(CommandContext args, CommandSource sender) throws CommandException {
        warnAboutSaveFailures(sender);
    ...
    @Command(aliases = {"load", "reload"},
            ...
            flags = "w:")
    public void load(CommandContext args, final CommandSource sender) throws CommandException {
        warnAboutSaveFailures(sender);
    ...
    @Command(aliases = {"save", "write"},
            ...
            flags = "w:")
    public void save(CommandContext args, final CommandSource sender) throws CommandException {
        warnAboutSaveFailures(sender);
    ...
    public void migrateDB(CommandContext args, CommandSource sender) throws CommandException {
        // Check permissions
        ...
        try {
            ...
            sender.sendMessage(Texts.of(TextColors.YELLOW, "Now performing migration... this may take a while."));
    ...
    public void migrateUuid(CommandContext args, CommandSource sender) throws CommandException {
        // Check permissions
        ...
        try {
            ...
            sender.sendMessage(Texts.of(TextColors.YELLOW, "Now performing migration... this may take a while."));
            container.migrate(migration);
            sender.sendMessage(Texts.of(TextColors.YELLOW, "Migration complete!"));
        } catch (MigrationException e) {
            log.log(Level.WARNING, "Failed to migrate", e);
            throw new CommandException("Error encountered while migrating: " + e.getMessage());
        } finally {
    ...
    public void teleport(CommandContext args, CommandSource sender) throws CommandException {
        ...
        player.setLocationSafely(teleportLocation.getLocation());
        sender.sendMessage(Texts.of("Teleported you to the region '" + existing.getId() + "'."));
    }
}
