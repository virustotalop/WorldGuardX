...
public class MemberCommands extends RegionCommandsBase {
    ...
    @Command(aliases = {"addmember", "addmember", "addmem", "am"},
            ...
            min = 2)
    public void addMember(CommandContext args, CommandSource sender) throws CommandException {
    ...
    @Command(aliases = {"addowner", "addowner", "ao"},
            ...
            min = 2)
    public void addOwner(CommandContext args, CommandSource sender) throws CommandException {
        warnAboutSaveFailures(sender);
    ...
    @Command(aliases = {"removemember", "remmember", "removemem", "remmem", "rm"},
            ...
            min = 1)
    public void removeMember(CommandContext args, CommandSource sender) throws CommandException {
        warnAboutSaveFailures(sender);
    ...
    @Command(aliases = {"removeowner", "remowner", "ro"},
            ...
            desc = "Remove an owner to a region",
            min = 1)
    public void removeOwner(CommandContext args, CommandSource sender) throws CommandException {
        warnAboutSaveFailures(sender);
