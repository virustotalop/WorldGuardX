...
import static com.sk89q.worldguard.sponge.event.DelegateEvents.setSilent;
import static com.sk89q.worldguard.sponge.util.Events.fireAndTestCancel;
...
public class ProtectionQuery {
     ...
     */
    public boolean testBlockPlace(@Nullable Object cause, Location location, BlockType newMaterial) {
     ...
     * @return true if the action is permitted
     */
    public boolean testBlockBreak(@Nullable Object cause, Location block) {
     ...
     * @return true if the action is permitted
     */
    public boolean testBlockInteract(@Nullable Object cause, Location block) {
