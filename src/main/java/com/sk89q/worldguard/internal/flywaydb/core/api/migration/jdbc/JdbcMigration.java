 ...
 * from the class name. This can be overridden by also implementing the {@link com.sk89q.worldguard.internal.flywaydb.core.api.migration.MigrationInfoProvider}
 * interface, in which case it can be specified programmatically. The checksum of this migration (for validation)
 * will also be null, unless the migration also implements the {@link com.sk89q.worldguard.internal.flywaydb.core.api.migration.MigrationChecksumProvider},
 * in which case it can be returned programmatically.
 *
 * <p>When the JdbcMigration implements {@link com.sk89q.worldguard.internal.flywaydb.core.api.configuration.ConfigurationAware},
 * the master {@link com.sk89q.worldguard.internal.flywaydb.core.api.configuration.FlywayConfiguration} is automatically injected upon creation,
