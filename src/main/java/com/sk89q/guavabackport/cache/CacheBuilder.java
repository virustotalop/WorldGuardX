...
public final class CacheBuilder<K, V>
{
    ...
    CacheBuilder<K, V> keyEquivalence(final Equivalence<Object> equivalence) {
        ...
        this.keyEquivalence = (Equivalence<Object>)Preconditions.checkNotNull((Object)equivalence);
        return this;
    }
    ...
    CacheBuilder<K, V> valueEquivalence(final Equivalence<Object> equivalence) {
        ...
        this.valueEquivalence = (Equivalence<Object>)Preconditions.checkNotNull((Object)equivalence);
        return this;
    }
    ...
    public CacheBuilder<K, V> initialCapacity(final int initialCapacity) {
        Preconditions.checkState(this.initialCapacity == -1, "initial capacity was already set to %s", new Object[] { this.initialCapacity });
    ...
    public CacheBuilder<K, V> concurrencyLevel(final int concurrencyLevel) {
        Preconditions.checkState(this.concurrencyLevel == -1, "concurrency level was already set to %s", new Object[] { this.concurrencyLevel });
    ...
    public CacheBuilder<K, V> maximumSize(final long size) {
        Preconditions.checkState(this.maximumSize == -1L, "maximum size was already set to %s", new Object[] { this.maximumSize });
        Preconditions.checkState(this.maximumWeight == -1L, "maximum weight was already set to %s", new Object[] { this.maximumWeight });
    ...
    public <K1 extends K, V1 extends V> CacheBuilder<K1, V1> weigher(final Weigher<? super K1, ? super V1> weigher) {
        ...
        if (this.strictParsing) {
            Preconditions.checkState(this.maximumSize == -1L, "weigher can not be combined with maximum size", new Object[] { this.maximumSize });
        }
        this.weigher = (Weigher<? super K, ? super V>)Preconditions.checkNotNull((Object)weigher);
    ...
    CacheBuilder<K, V> setKeyStrength(final LocalCache.Strength strength) {
        ...
        this.keyStrength = (LocalCache.Strength)Preconditions.checkNotNull((Object)strength);
        return this;
    }
    ...
    CacheBuilder<K, V> setValueStrength(final LocalCache.Strength strength) {
        ...
        this.valueStrength = (LocalCache.Strength)Preconditions.checkNotNull((Object)strength);
        return this;
    }
    ...
    public CacheBuilder<K, V> expireAfterWrite(final long duration, final TimeUnit unit) {
        Preconditions.checkState(this.expireAfterWriteNanos == -1L, "expireAfterWrite was already set to %s ns", new Object[] { this.expireAfterWriteNanos });
    ...
    public CacheBuilder<K, V> expireAfterAccess(final long duration, final TimeUnit unit) {
        Preconditions.checkState(this.expireAfterAccessNanos == -1L, "expireAfterAccess was already set to %s ns", new Object[] { this.expireAfterAccessNanos });
        Preconditions.checkArgument(duration >= 0L, "duration cannot be negative: %s %s", new Object[] { duration, unit });
    ...
    public CacheBuilder<K, V> refreshAfterWrite(final long duration, final TimeUnit unit) {
        ...
        Preconditions.checkState(this.refreshNanos == -1L, "refresh was already set to %s ns", new Object[] { this.refreshNanos });
    ...
    static {
        ...
        CACHE_STATS_COUNTER = (Supplier)new Supplier<AbstractCache.StatsCounter>() {
